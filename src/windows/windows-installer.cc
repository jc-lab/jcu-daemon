...
int WindowsServiceInstaller::openServiceManager() {
  ...
  scm_handler_ = OpenSCManager(NULL,
                               NULL,
                               SC_MANAGER_CONNECT | SC_MANAGER_CREATE_SERVICE | SERVICE_QUERY_CONFIG
...
PlatformInstaller::Result WindowsServiceInstaller::install() {
  ...
  switch (start_mode_) {
    case Installer::START_AUTO:dwStartType = SERVICE_AUTO_START;
      break;
    case Installer::START_DEMAND:dwStartType = SERVICE_DEMAND_START;
      break;
  }
